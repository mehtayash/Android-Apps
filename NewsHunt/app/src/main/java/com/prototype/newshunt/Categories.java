 ...
 */
public class Categories extends ActionBarActivity implements Serializable{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (categories == null) {
            catArray.add(gridListArray.get(0));
            catArray.add(gridListArray.get(1));
            catArray.add(gridListArray.get(2));
